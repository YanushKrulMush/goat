...
class ListViewTest(TestCase):
    ...
    def test_invalid_input_dont_save_to_db(self):
    ...
    def test_invalid_input_shows_error_page(self):
        response = self.post_invalid_input()
        self.assertContains(response, escape(EMPTY_ITEM_ERROR))
    ...
    def test_duplicate_items_validation_errors_appear_on_list_page(self):
